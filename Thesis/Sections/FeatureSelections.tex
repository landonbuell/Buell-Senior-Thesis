...
\paragraph*{}From time space, we use the following $10$ features:
...
\item[•] Waveform Mean, Median, and Mode 
...
\begin{equation}
\label{eqn-RMS}
\text{RMS}\big[ a^{(i)} \big] = \sqrt{\frac{1}{N} \sum_{j=0}^{N-1} \big( a^{(i)}[j]} \big)^2
\end{equation}
