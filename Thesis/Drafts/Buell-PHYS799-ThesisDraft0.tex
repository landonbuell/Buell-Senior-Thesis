...
\paragraph*{}Consider the task of identifying the source of a sound. 
...
\end{center}
\caption{The precision score (a) and recall score (b) generally increase with each training step}
...
\caption{Performance metrics across $10$ models and $37$ classes}
...
\paragraph*{}We show the metric values of all splits to show the consistency in performance across all subsets. Notice how the models each perform reasonably well (precision and recall score consistently above 80\%). This indicates that for this data set, architecture, and feature selection, our model can performance reasonably and generalize appropriately. This step is critical in ensuring that there are no major out-liers in the classification results, and that any set of initial conditions can still allow the model to reach an acceptable set of parameters and decision boundaries. The results of cross validation indicate a strong classier that can be implemented to make predictions on other waveforms.
...
\begin{figure}[H]
	...
	\caption{Unimodal Architecture, See left side of Fig. (\ref{fig-NetworkArchitecture})}
	\end{subfigure}	
	
	\begin{subfigure}[b]{0.9\textwidth}
	\centering
	\includegraphics[scale=0.3]{../FiguresMetrics/AvgXval-Perceptron}
	\caption{Unimodal Architecture, See right side of Fig. (\ref{fig-NetworkArchitecture})}
	\end{subfigure}
...
\begin{figure}[H]
	...
	\caption{Standard Confusion Matrix for Convolution Branch}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.45\textwidth}
	\centering
	\includegraphics[scale=0.18]{../FiguresMetrics/XValGammaCNN_Avg_Hits_Weighted_Confusion}
	\caption{Occurance Weighted Confusion Matrix for Convolution Branch}
	\end{subfigure}	

	\begin{subfigure}[b]{0.45\textwidth}
	\centering
	\includegraphics[scale=0.18]{../FiguresMetrics/XValBetaMLP_Avg_Standard_Confusion}
	\caption{Standard Confusion Matrix for Perceptron Branch}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.45\textwidth}
	\centering
	\includegraphics[scale=0.18]{../FiguresMetrics/XValBetaMLP_Avg_Hits_Weighted_Confusion}
	\caption{Occurance Weighted Confusion Matrix for Perceptron Branch}
	\end{subfigure}	
	\label{fig-MultimodalConfs}
\end{figure}
