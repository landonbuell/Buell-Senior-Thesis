...
\end{equation}
We show the effect of a Hanning window on a wae 
\begin{figure}[H]

	\begin{subfigure}{1.0\textwidth}
	\centering
	%\includegraphics[width=\textwidth , height=0.2\textheight]{../FiguresFeatures/Auto_Correlation_4}
	\caption{A section of a waveform, $1024$ samples long}
	\end{subfigure}	
