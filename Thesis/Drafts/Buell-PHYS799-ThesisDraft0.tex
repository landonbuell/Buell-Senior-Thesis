...
\subsection{Layers Used in this Classification Neural Network}
\label{subsec-Layers}
...
\paragraph*{}Classification tasks require a set of inputs  . These inputs are called \textit{predictors} or \textit{features} \cite{James,Loy,Serizel}. Features are quantitative, low-dimensional representations of each sample that convey key characteristics of the sample. 
...
\paragraph*{}From each audio file sample, we derive an identical set of $p$ predictors that will be 
