...
\textcolor{red}{Insert spectrograms here}
	...
	\centering
	\includegraphics[width=0.45\textwidth , height=0.2\textheight]{../Figures/AnalysisFrame}
...
\end{quote}
Thus, indexes where $i = j$ represents a correct prediction, and $i \neq k$ indicates an incorrect prediction. A confusion matrix with relatively large values in main diagonal indicates a model that consistently predicts correct labels \cite{Geron}.  Below we present some "dummy" confusion matrices as numerical arrays, and a corresponding heat-map equivalent.

\begin{figure}[H]

	\begin{subfigure}[h]{\textwidth , 0.8\textheight}
	\begin{center}
