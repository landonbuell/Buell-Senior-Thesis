...
\paragraph*{}This concept stems from the idea that a trained neural network classifier is basing its predictions by generating \textit{decision boundaries} in feature space \cite{Loy,James,Serizel}. 
...
\begin{figure}[H]
\begin{center}
%textcolor{red}{Plot of TDE Feature Here}
\includegraphics[scale=0.3]{../FiguresFeatures/TDE}
\end{center}
