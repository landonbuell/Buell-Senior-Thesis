...
class NetworkContainer:
    ...
    """
    def __init__(self,modelName,n_classes,path,inputAShape,new=True):
    ...
    def CreateNewModel (self):
        ...
        * no args
        ...
        """
        return NeuralNetworkModels.ConvolutionalNeuralNetwork2D(self.name,
                            self.shapeA,self.n_classes,
...
class NeuralNetworkModels:
    ...
    * no args
    ...
    @staticmethod
    def ConvolutionalNeuralNetwork2D (modelName,inputShape,outputShape,filterSizes=[32,32],
