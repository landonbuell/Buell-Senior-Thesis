...
class FileIterator :
    ...
    def FeatureExtractor (self,file):
        ...
        featureVector = np.append(featureVector,freqSeriesFeatures.MelFrequencyCeptralCoefficients())
        featureVector = np.append(featureVector,freqSeriesFeatures.CenterOfMass())
